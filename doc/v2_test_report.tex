...
\section{Phase C - Crowd Sourced Tests}

This section describes the test results collected from a crowd sourced OTA test campaign. The goals of this test campaign are:
\begin{enumerate}
\item Gather further stored file OTA samples to support the Phase A \& B results, but from a wider range of speakers, HF channels, radio hardware, and applications integrating RADE V2.
...
\begin{table} [h]
\caption{Phase C Test Goals.}
\label{tab:phase3_goals}
\centering
\begin{tabular}{ l | c | c }
 \hline
 Goal & Target Samples & Collected Samples \\
 \hline
 Number of stored file OTA samples to collect & 20 \\
 Number of languages & 3 \\
 Real Time PTT conversations & 10 \\
 PAPR measurements & 3 \\
 \hline
 \hline
\end{tabular}
...
The procedures for stored file and PTT tests are documented \href{https://github.com/drowe67/radae/blob/0b1279995f79e00007237ec709a560b256f7daa0/README.md#testing-rade}{here}.  Any PTT results must be from an application of radio that has RADE V2 integration verified using \href{https://github.com/drowe67/radae/blob/0b1279995f79e00007237ec709a560b256f7daa0/README.md#verifying-rade-integration}{this} procedure.  Samples submitted must include the source audio fed to the RADE encoder, plus the received off air signal.  The idea is to have enough information to reproduce the results (e.g. by passing through the RADE decoder) and measure the loss compared to a software simulation reference. For the PAPR measurements it would be useful to have the source audio so we can measure the PAPR of the software only signal.

\section{Conclusion}

In Table \ref{tab:conclusion} the results from Phase A and B are summarised and compared to requirements extracted from FreeDV-038.  Phase C is a work in progress.  Only performance and functional requirements have been extracted (e.g. we don't consider implementation issues like a C port or packaging).
